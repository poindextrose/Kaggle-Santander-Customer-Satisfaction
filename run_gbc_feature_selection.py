...
parameters = {'selector__percentile': stats.randint(10, 100),
              'gbc__loss': ['deviance', 'exponential'],
              'gbc__learning_rate': stats.expon(1e-3, 0.1),
              'gbc__n_estimators': stats.randint(10,500),
              'gbc__max_depth': stats.randint(2, 15),
              'gbc__min_samples_split': stats.randint(2, 6),
              'gbc__min_samples_leaf': stats.randint(1, 3),
              'gbc__min_weight_fraction_leaf': stats.uniform(0., 0.5),
